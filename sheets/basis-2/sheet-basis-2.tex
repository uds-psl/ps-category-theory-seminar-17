...
\begin{answer}
  \begin{enumerate}
  \item A subcategory of an ordered set $(S,\leq)$ is an ordered set $(S',\leq')$ such that $S'\subseteq S$ and $\leq'\;\subseteq\;\leq$. In the case of full subcategories even $\leq'\;=\;\leq$ holds.
