...
\begin{answer}
  ...
  \item Consider $\B$ given by
    ...
    Indeed, the reverse is also true: given any injection $f'\from A'\to B'$ there is functor which $F\from \A\to\Set$ such that $f'$ corresponds to $F$ (in the way specified above).
  \end{enumerate}
\end{answer}
