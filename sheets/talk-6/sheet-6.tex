  ...
  \begin{itemize}
    ...
    \item[``$\Leftarrow$'']
      \begin{proof}
        ...
        First we note that the diagramm $\xymatrix@1{E \ar[r]^i &X \ar@<.5ex>[r]^{f} \ar@<-.5ex>[r]_g &Y}$ is indeed a fork as it commutes by assumption.
        Let
        $ \xymatrix{
          A \ar[r]^f & X \ar@<.5ex>[r]^s \ar@<-.5ex>[r]_t & Y
        } $
        ...
        commutes. First it is clear that this diagramm commutes for $\bar{f}$. Now let $\tilde{f}$ be another map such that
        \[ \xymatrix{
