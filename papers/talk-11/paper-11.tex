...
\end{example}
\begin{example}
  We also have the identity context morphism $1$ (from now on we will use $1$
  as the suitable identity morphism for the surroundings) for any $\Gamma = x_1
  : A_1, \dots, x_n : A_n$, which is $(x_1, \dots, x_n)$.
\end{example}
