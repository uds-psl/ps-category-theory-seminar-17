...
\begin{defn}[Natural transformation]
  ...
  The commuting square (\ref{eq:nat}) is also called the \demph{naturality axiom} (though this is not a axiom in logical sense but a defined property for some $\alpha$).
\end{defn}
