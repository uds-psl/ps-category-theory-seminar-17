...
% explanation over relation sign
...
\todo{Soll ich die Verallgemeinerten Produkte über Klassen von Objekten auch einführen?}
...
\begin{example}[Pullbacks and products]
...
\section*{Conclusion}
We have seen much analogous definitions.
Our definitions follow a simple ``pattern'':
\todo{Pattern könnte besser erklärt werden aber nicht zu formal!}
\begin{itemize}
